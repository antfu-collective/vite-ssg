...
We ship [`@unhead/vue`](https://unhead.unjs.io/docs/vue/head/guides/get-started/overview) to manage the document-head out of the box. You can use it directly in your pages/components.
For example:
...
See [`@unhead/vue`'s docs](https://unhead.unjs.io/docs/vue/head/guides/get-started/installation) for more usage information about `useHead`.
